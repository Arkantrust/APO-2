...
public class ContactListTest {
    ...
    public void testcase3(){
        ...
        try{
            ...
            Node<Contact, String> n0 = new Node<Contact, String>(c0, c0.getPhone());
            contactList.addLast(n0);
            assertNotEquals(n0, contactList.search("70"));
        }catch(EmptyFieldException e){
    ...
    @Test
    public void testcase4SearchEmptyList(){
        setup1();
        Node<Contact, String> resultSearch = contactList.search("30");
        assertNull(resultSearch); // la lista esta vacia
    }

    @Test
    public void testcase5(){
        setup2();
        Node<Contact, String> resultSearch = contactList.search("75");
        assertNull(resultSearch); // el nodo no fue encontrado
    }
    ...
    public void testcase6(){
        ...
        try{
            Contact c0 = new Contact(null, "", "Sebastian.email@gmail.com");
            Node<Contact, String> n0 = new Node<Contact, String>(c0, c0.getPhone());
            contactList.addLast(n0);
